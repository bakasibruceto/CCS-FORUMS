                                    ...
                                    <div x-data="{ open: false }" class="relative">
                                        ...
                                        <div x-show="open" @click.away="open = false" class="absolute right-0 mt-2 w-48 rounded-md shadow-lg bg-white ring-1 ring-black ring-opacity-5">
                                            <div class="py-1" role="menu" aria-orientation="vertical" aria-labelledby="options-menu">
                                                <a href="#" class="px-4 py-2 text-sm hover:bg-gray-100 flex items-center" role="menuitem">
                                                ...
                                                <a href="#" class="px-4 py-2 text-sm text-red-500 hover:bg-gray-100 hover:text-red-700 flex items-center" role="menuitem">
                                                    <svg class="-ml-1" width="24" height="24" fill="none" xmlns="http://www.w3.org/2000/svg" >
